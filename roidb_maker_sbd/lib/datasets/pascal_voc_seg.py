...
class PascalVOCSeg(PascalVOCDet):
    ...
    def image_path_at(self, i):
        ...
        image_path = os.path.join(self._data_path,'VOC2012', 'img', self._image_index[i] + self._image_ext)
    ...
    def _load_sbd_mask_annotations(self, index, gt_roidbs):
        ...
        inst_file_name = os.path.join(self._data_path, 'VOC2012', 'inst', image_name + '.mat')
        ...
        cls_file_name = os.path.join(self._data_path, 'VOC2012','cls', image_name + '.mat')
