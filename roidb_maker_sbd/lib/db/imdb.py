...
devkit_path = '/home/alfonso/VOCbenchmark/'

__sets = {
    'voc_2012_seg_train': (lambda: PascalVOCSeg('train', '2012', devkit_path)),
    'voc_2012_seg_val': (lambda: PascalVOCSeg('val', '2012', devkit_path)),
